...
class OverlayScreenshotProjectionActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Best-effort: collapse any open system dialog/shade before the consent prompt
        // so the resulting capture does not include the shade. This is a privileged
        // broadcast on Android 12+ and silently no-ops for us — we do not rely on it.
        try {
