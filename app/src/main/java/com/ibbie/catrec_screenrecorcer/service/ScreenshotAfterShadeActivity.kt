 ...
 * [ScreenRecordService.ACTION_TAKE_SCREENSHOT] runs. Launched via [PendingIntent.getActivity]
 * from the notification so Android automatically collapses the shade before delivering focus.
 *
