...
class ScreenshotPostActionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val preview = ImageView(this).apply {
            layoutParams = LinearLayout.LayoutParams(dp(132), dp(176)).apply {
                bottomMargin = dp(10)
            }
        ...
        val shareBtn = ImageButton(this).apply {
            layoutParams = LinearLayout.LayoutParams(btnSize, btnSize).apply { marginEnd = dp(14) }
            background = AppCompatResources.getDrawable(this@ScreenshotPostActionActivity, R.drawable.bg_post_action_circle)
        ...
        val editBtn = ImageButton(this).apply {
            ...
            background = AppCompatResources.getDrawable(this@ScreenshotPostActionActivity, R.drawable.bg_post_action_circle)
            setImageResource(R.drawable.ic_brush_auto_fix)
            imageTintList = android.content.res.ColorStateList.valueOf(0xFFFFFFFF.toInt())
            scaleType = ImageView.ScaleType.CENTER_INSIDE
            setPadding(dp(12))
            contentDescription = getString(R.string.screenshot_post_edit)
            setOnClickListener {
